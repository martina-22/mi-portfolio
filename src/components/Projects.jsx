...
import { workExperience, personalProjects } from '../data/projects';
...
const Projects = () => {
    ...
    const allItems = [...workExperience, ...personalProjects];
    ...
    const SectionHeader = ({ title, icon: Icon }) => (
        ...
        >
            <span style={{
                ...
                {Icon && <Icon size={40} strokeWidth={1.5} color="var(--accent-primary)" style={{ opacity: 0.8 }} />}
                {title}
            </span>
            <span style={{
                height: '2px',
    ...
    return (
        <section id="projects" style={{ padding: '100px 20px' }}>
            ...
            <div style={{ marginBottom: '6rem' }}>
                <SectionHeader title="Experiencia Laboral" icon={Briefcase} />
            ...
            <div>
                <SectionHeader title="Proyectos Realizados" icon={FolderGit2} />
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(300px, 1fr))', gap: '20px' }}>
